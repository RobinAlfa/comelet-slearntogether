...
time.sleep(10)
chaabi = "B123456789mi.lab"
timeout = "10"
    
for x, y, duration in actions:
    if (x, y, duration) == (387, 253, 10):
        pag.click(x, y, duration=duration)
        pag.typewrite(chaabi)
...
def save_command():
    ...
    chaabi_echo = 'HeavyDirector chaabi : Bxxxxxxxxxxxxxab'  
    save_echo_to_batch('wow.bat', f'heavydirector: {clipboard_text}')
    save_echo_to_batch('wow.bat', chaabi_echo)

if __name__ == "__main__":
    save_command()

print("Done , Popin above")
